/**
 * Mermaid diagram serialization for BlockNote.
 * Handles bidirectional conversion between Markdown fenced code blocks
 * and BlockNote's custom mermaid block type.
 *
 * Originally from Tolaria (github.com/refactoringhq/tolaria), adapted for M3Flow.
 */

import { serializeMathAwareBlocks } from './math-markdown.ts'

export const MERMAID_BLOCK_TYPE = 'mermaidBlock'

const TOKEN_PREFIX = '@@M3FLOW_MERMAID_BLOCK:'
const TOKEN_SUFFIX = '@@'
