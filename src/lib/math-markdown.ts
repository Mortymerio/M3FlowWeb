/**
 * LaTeX math serialization for BlockNote.
 * Handles bidirectional conversion between $...$ / $$...$$ Markdown
 * and BlockNote's custom math inline/block types.
 *
 * Originally from Tolaria (github.com/refactoringhq/tolaria), adapted for M3Flow.
 */
...
const INLINE_TOKEN_PREFIX = '@@M3FLOW_MATH_INLINE:'
const BLOCK_TOKEN_PREFIX = '@@M3FLOW_MATH_BLOCK:'
const TOKEN_SUFFIX = '@@'
const INLINE_TOKEN_RE = /@@M3FLOW_MATH_INLINE:([^@]+)@@/g
...
export function preProcessMathMarkdown({ markdown }: { markdown: string }): string {
