...
try {
  ...
  contextBridge.exposeInMainWorld('dbAPI', {
    ...
    exportCSV: (title: string, content: string) => ipcRenderer.invoke('export-csv', { title, content }),
    exportPDF: (title: string) => ipcRenderer.invoke('export-pdf', { title }),
    importWorkspace: () => ipcRenderer.invoke('import-workspace'),
    moveNotebook: (notebookId: string, parentId: string | null) => ipcRenderer.invoke('move-notebook', { notebookId, parentId }),
    moveNote: (noteId: string, notebookId: string) => ipcRenderer.invoke('move-note', { noteId, notebookId }),
